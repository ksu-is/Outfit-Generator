...
have established a Github account and join class organization in Github by accepting the invite email
 be associated with ownership of a code repository in our Github organization
have edited and committed changes in a readme.md file in their repository in our Github organization. The commits should show in Github.
should have explored at least one existing Python code base related to their project to evaluate using it in their project and submitted updates to the projectroadmap.md file explaining their findings.
